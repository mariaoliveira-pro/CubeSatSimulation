...
impl Network {
    ...
    pub fn send_data(&mut self,battery_level: f32, battery_capacity: f32, orbit_number: u32, mission_state: MissionState, operational_mode: OperationalMode, solar_panel_output: f32, tick_atual: u32) {
        let message = Message {
            battery_level,
            battery_capacity,
            orbit_number,
